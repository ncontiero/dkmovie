...
const badgeVariants = cva(
  `
    ...
    aria-invalid:border-destructive dark:aria-invalid:ring-destructive/40 inline-flex w-fit shrink-0 items-center
    justify-center gap-1 overflow-hidden rounded-full border px-2 py-0.5 text-xs font-medium whitespace-nowrap
    transition-[color,box-shadow] [&>svg]:pointer-events-none [&>svg]:size-3
  `,
  {
    variants: {
      variant: {
        ...
        defaultOutline: "bg-primary/10 text-primary border-primary",
        secondary:
          "bg-secondary text-secondary-foreground border-transparent [a&]:hover:bg-secondary/90",
        destructive: `
          bg-destructive border-transparent text-white [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20
